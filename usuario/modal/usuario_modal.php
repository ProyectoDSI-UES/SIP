        ...
        <form class="form-horizontal" method="POST" action="usuario_add.php" enctype="multipart/form-data"
          ...
          <div class="form-group">
            ...
            <select class="form-control select2" name="id_plaza" required>
              ...
              ?>
                <option value="<?php echo $row_plaza['id_plaza']; ?>"><?php echo $row_plaza['nombre']; ?></option>
              <?php } ?>
            </select>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
          <select class="form-control select2" name="id_rol" required>
            <?php
            $query_roles = mysqli_query($conn, "SELECT * FROM roles where estado = 1") or die(mysqli_error($conn));
