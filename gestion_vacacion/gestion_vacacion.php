                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <a href="#" data-toggle="modal" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i> Nuevo</a>
                            </div>
                            <div class="box-body">
                            ...
                            JOIN usuario ON solicitudes_vacaciones.id_empleado = usuario.id";
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-info btn-print" href="<?php echo "procesar_vacacion.php?id_solicitud=$id_solicitud"; ?>" role="button">Ver solicitud</a>
                                                </td>
                                            </tr>
                                        <?php
                                        }
