...
<!-- jQuery UI 1.11.4 -->
<script src="../includes/bower_components/jquery-ui/jquery-ui.min.js"></script>
<!-- DataTables -->
...
<script src="../includes/bower_components/morris.js/morris.min.js"></script>
<!-- ChartJS -->
<script src="../includes/bower_components/chart.js/Chart.js"></script>
<!-- Sparkline -->
<script src="../includes/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js"></script>
<!-- jvectormap -->
...
<!-- jQuery Knob Chart -->
<script src="../includes/bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
<!-- daterangepicker -->
<script src="../includes/bower_components/moment/min/moment.min.js"></script>
<script src="../includes/bower_components/bootstrap-daterangepicker/daterangepicker.js"></script>
<!-- datepicker -->
